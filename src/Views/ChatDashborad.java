 ...
 * @author AZA
 */
public class ChatDashborad extends javax.swing.JFrame {

    /**
     * Creates new form ChatDashborad
     */
    public ChatDashborad() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hello Mr Ahmed");
        ...
        jLabel3.setText("Your Coversation With Mohamed");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatDashborad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatDashborad().setVisible(true);
            }
        });
    }
